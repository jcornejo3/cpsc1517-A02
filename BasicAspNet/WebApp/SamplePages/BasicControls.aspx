<%@ Page Title="Basic Common Web Controls" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BasicControls.aspx.cs" Inherits="WebApp.SamplePages.BasicControls" %>
   ...
   <table align="center" style="width: 80%">
        <tr>
            ...
            <!--Discussion about SUBMIT BUTTON
                ...
                access type is DEPEND on the control
                ALL controls ar objects
                when the button is pressed, your page will execute the code
                associated with the control: event driven logic

                Event logic:
                    a.) obtain input from textbox
                    b.) test if data is present.
                            -No Data?
                            -Yes Data?
                Use textbox input to:
                    c.) position in checkbox
                    d.) set radio on if choice is programe
                    e.) position in the drop down list
                    f.) use dropdown info to display some text
